 ...
 */
function getSmallMarkerIcon(city: City, isCrownVault: boolean, isPriveExchange: boolean): string {
  ...
  // Crown Vault assets - always show crown icon (priority over everything else)
  if (isCrownVault) {
  ...
  // Privé Exchange (Victor scored or from Privé source) - show diamond icon
  if (isPriveExchange) {
    return `<svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
