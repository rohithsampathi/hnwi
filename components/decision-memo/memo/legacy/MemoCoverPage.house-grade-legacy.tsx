    ...
    >
      ...
      <div className="relative z-10 text-center px-5 sm:px-16 max-w-4xl">
        ...
        <motion.h2
          ...
          {...fadeUp(0.6)}
        >
          {reportTitle || 'House-Governed Release Readiness Memo'}
        </motion.h2>
          ...
          >
            ...
            {totalSavings && (
              <motion.div
                ...
                whileHover={{ y: -2 }}
              >
                <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground/60 mb-4">{headlineMetricLabel || 'Value Creation'}</p>
