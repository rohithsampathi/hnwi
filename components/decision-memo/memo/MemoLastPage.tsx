...
export function MemoLastPage({
  ...
  return (
    <motion.div
      className="relative min-h-[100vh] bg-[#0A0A0A] flex-col items-center justify-center overflow-hidden hidden print:flex print:break-before-page print:h-[270mm] print:max-h-[270mm] print:min-h-[270mm] print:w-[180mm] print:overflow-hidden print:mx-auto"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
