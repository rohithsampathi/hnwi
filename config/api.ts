...
// Kingdom is the canonical backend. Developers who need a local backend should
// opt in with API_BASE_URL=http://localhost:8000 for that session.
const defaultApiBaseUrl = KINGDOM_API_BASE_URL;
