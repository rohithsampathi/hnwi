...
export default function Home() {
  ...
  useEffect(() => {
    import("@/lib/auth-utils").then(({ isAuthenticated, getSessionState, SessionState }) => {
      // Enhanced session check using utility function
      try {
        const authResult = isAuthenticated();
        const sessionState = getSessionState();
        
        // Consider both authenticated and locked_inactive as logged in for page routing
        // This prevents redirect to login on refresh when session is locked but valid
        const isLoggedInState = authResult || sessionState === SessionState.LOCKED_INACTIVE;
