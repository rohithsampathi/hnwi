    ...
    cities.forEach(city => {
      ...
      city.devIds.forEach(devId => {
        ...
        const source = buildCitationSourceDevelopment({
          ...
          full_castle_brief: city.full_castle_brief,
          castle_brief: city.castle_brief,
          castle_brief_enriched: city.castle_brief_enriched,
          full_analysis: city.full_analysis,
          brief_source_text: city.brief_source_text,
          public_mirror_excerpt: city.public_mirror_excerpt,
          content: city.full_analysis || city.analysis || city.elite_pulse_analysis || city.katherine_analysis,
          source_article_date: city.source_article_date,
          source_published_at: city.source_published_at,
          published_at: city.published_at,
          article_date: city.article_date,
